 ...
 */
export interface ScheduleOSUpdateCommand {
  PayloadKeys?: {
    /**
    ...
    Updates?: {
      ...
      ProductKey?: string;
      /**
       * The version of the update, which the system requires if 'ProductKey' isn't present. Rapid Security Response updates are not able to be installed using this command. This value is available in iOS 11.3 and later, macOS 12 and later, and tvOS 12.2 and later.
       */
  ...
  ResponseKeys?: {
    ...
    UpdateResults: {
       ...
       * * 'InstallForceRestart': Perform the 'Default' action, and then force a restart if the update requires it. This value is available in macOS 11 and later.
       */
      InstallAction: "Error" | "DownloadOnly" | "InstallASAP" | "NotifyOnly" | "InstallLater" | "InstallForceRestart";
      /**
