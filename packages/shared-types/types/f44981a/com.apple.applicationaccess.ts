...
export interface ComAppleApplicationaccess {
  /**
   * If  'false', disables account modification. Requires a supervised device. Available in iOS 7 and later, macOS 14 and later, and watchOS 10 and later.
   */
  ...
  /**
   * If 'false', prevents modifying the Remote Management Sharing setting in System Settings. Available in macOS 14 and later.
   */
  ...
  /**
   * If 'false', prevents modifying Bluetooth setting in System Settings. Available in macOS 14 and later.
   */
  ...
  /**
   * If 'false', the user can't download Apple Books media that's tagged as erotica. Available in iOS 6 and later, and tvOS 11.3 and later. This restriction will require supervision in a future release.
   */
  ...
  /**
   * If 'false', disallows iCloud Freeform services. Available in macOS 14 and later.
   */
  ...
  /**
   * If 'false', prevents the user from changing the device name. Requires a supervised device. Available in iOS 9 and later, macOS 14 and later, and tvOS 11.0 and later.
   */
  ...
  /**
   * If 'false', prevents modifying File Sharing setting in System Settings. Available in macOS 14 and later.
   */
  ...
  /**
   * If 'false', prevents modifying Internet Sharing setting in System Settings. Available in macOS 14 and later.
   */
  allowInternetSharingModification?: boolean;
  /**
   * If 'false', disallows iPhone widgets on a Mac that has signed in the same Apple ID for iCloud. Supervised only. Available on iOS 17 and later.
   */
  ...
  /**
   * If 'false', prevents creating new users in System Settings. Available in macOS 14 and later.
   */
  ...
  /**
   * If 'false', disables Photo Stream. Available in iOS 5 and later. This restriction is deprecated and will be removed in a future release.
   */
  ...
  /**
   * If 'false', prevents modifying Printer Sharing setting in System Settings. Available in macOS 14 and later.
   */
  ...
  /**
   * If 'false', prohibits installation of rapid security responses. Available in iOS 16 and later and macOS 13 and later.
   */
  allowRapidSecurityResponseInstallation?: boolean;
  /**
   * If 'false', prohibits removal of rapid security responses. Available in iOS 16 and later and macOS 13 and later.
   */
  allowRapidSecurityResponseRemoval?: boolean;
  /**
   * If 'false', prevents modifying Remote Apple Events Sharing setting in System Settings. Available in macOS 14 and later.
   */
  ...
  /**
   * If 'false', prevents modification of Startup Disk setting in System Settings. Available in macOS 14 and later.
   */
  ...
  /**
   * If 'false', prevents modification of Time Machine settings in System Settings. Available in macOS 14 and later.
   */
  ...
  /**
   * If 'false', disables voice dialing if the device is locked with a passcode. Available in iOS 4 and later. This restriction is deprecated and will be removed in a future release.
   */
  ...
  /**
   * This restriction allows the admin to set how many days to delay a minor OS software update on the device. When this restriction is in place the user see a software update only after the specified delay after the release of the software update. This value controls the delay for 'forceDelayedSoftwareUpdates'. Available in macOS 11.3 and later.
   */
  ...
  /**
   * If 'true', delays user visibility of major upgrades to OS Software. Available in macOS 11.3 and later.
   */
  ...
  /**
   * If 'true', forces the user to enter their iTunes password for each transaction. Available in iOS 6 and later. This restriction is deprecated and will be removed in a future release.
   */
  forceITunesStorePasswordEntry?: boolean;
  /**
   * If 'true', limits ad tracking. Additionally, it disables app tracking and the Allow Apps To Request To Track setting. Available in iOS 7 and later.
   */
  ...
  /**
   * If 'true', limits device to only join Wi-Fi networks set up through a configuration profile. Requires a supervised device. Available in iOS 14.5 and later.
   */
